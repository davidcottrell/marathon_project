...
percentile and the other at the 92rd.  While these two residuals are
...
proxy for her underlying marathon skill, we estimate $\beta_0$,
...
seconds. In fact, our simulations estimate that Anna should have
finished the Rio marathon in 9,181 seconds, which is slightly more
than 12 minutes faster than her actual time. Lisa Hahner's
corresponding 95\% interval is 8,507 to 10,143 with an observed
