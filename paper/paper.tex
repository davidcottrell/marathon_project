...
with a mean that is a quadratic function of the runner's marathon
...
\item Ignoring twins and triplets, estimate with least squares a
  ...
  her pre-Olympic personal best time $X_i$, her best time squared
  $X^2_{i}$, and her age $Z_i$.
...
\item For each simulated rate, draw intercept and slope estimates
  $\tilde{\beta}_0$, $\tilde{\beta}_1$, $\tilde{\beta}_2$, and
  $\tilde{\beta}_3$, respectively, from a multivariate normal
...
about the relationship between runner talent and age and runer finish
